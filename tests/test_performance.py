...
class TestPerformance:
    ...
    def mock_output_aircraft_performance_range_schema(self, mocker):
        return mocker.patch(
            "src.schemas.OutputAircraftPerformanceRangeSchema",
    ...
    def mock_input_aircraft_performance_endurance_schema(self, mocker):
        return mocker.patch(
            "src.schemas.InputAircraftPerformanceEnduranceSchema",
    ...
    def mock_output_aircraft_performance_endurance_schema(self, mocker):
        return mocker.patch(
            "src.schemas.OutputAircraftPerformanceEnduranceSchema",
            OutputAircraftPerformanceEnduranceSchema(name="C-152", endurance="04:00"),
        )

    def test_calculate_range(
        self,
        mock_input_aircraft_performance_range_schema,
        mock_output_aircraft_performance_range_schema,
        load_data,
        db_session,
    ):
        output = Performance(db_session).calculate_range(input_data=mock_input_aircraft_performance_range_schema)
    ...
    def test_calculate_endurance(
        self,
        mock_input_aircraft_performance_endurance_schema,
        mock_output_aircraft_performance_endurance_schema,
        load_data,
        db_session,
    ):
